/* =====================================================================
   ...
   Înainte de prima rulare:
     copiați Parole.example.sql -> Parole.local.sql și completați parolele.
     Parole.local.sql este în .gitignore și NU ajunge pe GitHub.

   Din linia de comandă, din folderul "SQL Code":
     sqlcmd -S <server>,<port> -U <dba> -f 65001 -i 00_RunAll.sql

   Din SSMS: Query > SQLCMD Mode, setați ScriptsPath la calea absolută, F5.

   Ordine:
     01 bază de date   02 schemă        03 tabele        04 indici
     05 funcții        06 views         07 proceduri     08 securitate
     09 joburi Agent   11 seed          12 conturi echipă
...
-- Parolele (ParolaApp, ParolaRapoarte, ParolaSql*, ParolaApp*)
:r $(ScriptsPath)\Parole.local.sql
...
:r $(ScriptsPath)\12_TeamAccounts.sql
